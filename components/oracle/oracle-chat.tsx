...
export function OracleChat({ onClose, onMicClick }: OracleChatProps) {
    const { user } = useUser();
                ...
                <form onSubmit={handleSubmit} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 relative">
                        ...
                        <button
                            ...
                            className="absolute right-1.5 top-1/2 -translate-y-1/2 p-2 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-blue-500/40 transition-all"
                        >
                            {isLoading ? (
                    ...
                    {/* Mic button outside - triggers voice mode */}
                    <button
                        type="button"
                        onClick={onMicClick}
