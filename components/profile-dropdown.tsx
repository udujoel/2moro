...
export function ProfileDropdown() {
    const { profileImage, resetOnboarding } = useUser();
        ...
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <div className="text-right hidden sm:block">
                    <p className="text-sm font-semibold">The Architect</p>
                ...
                {isOpen && (
                    ...
                    >
                        <div className="px-4 py-3 border-b border-border/50 mb-2">
                            ...
                            <p className="text-xs text-muted-foreground truncate">architect@2moro.app</p>
                        </div>
