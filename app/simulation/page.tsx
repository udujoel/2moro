                        ...
                        <AnimatePresence mode="wait">
                            {activeView === "vision" ? (
                                ...
                                >
                                    ...
                                    <div className={`transition-all duration-700 ease-out ${activeView === 'voice' ? 'blur-md opacity-30 scale-[0.98]' : ''}`}>
                                        {/* Greeting */}
                                        ...
                                        {activeView === "voice" && (
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    className="absolute top-0 right-0 p-3 text-slate-400 hover:text-white transition-colors"
                                                >
                                                    <X className="w-6 h-6" />
                                                </button>
                                                ...
                                                <motion.div
                                                    ...
                                                    className="mt-8 text-center max-w-lg px-4 min-h-[80px]"
                                                >
                                                    {displayText ? (
                                                ...
                                                {/* Text input fallback */}
                                                {showTextInput && (
                                                    <form onSubmit={handleTextSubmit} className="mt-6 w-full max-w-md px-4">
